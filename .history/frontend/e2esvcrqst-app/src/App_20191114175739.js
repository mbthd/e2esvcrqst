            ...
            <Router>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <NavDropdown title="Display" id="basic-nav-dropdown">
                        ...
                        <NavDropdown.Item href="#display/3.2">Service Request</NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item href="#display/3.4">Separated link</NavDropdown.Item>
                    </NavDropdown>
                    <NavDropdown title="Add" id="basic-nav-dropdown">
                        {/* <NavDropdown.Item href="#add/3.1">Contacts</NavDropdown.Item> */}
                        ...
                        <NavDropdown.Item href="#add/3.2">Service Request</NavDropdown.Item>
                        <NavDropdown.Divider />
